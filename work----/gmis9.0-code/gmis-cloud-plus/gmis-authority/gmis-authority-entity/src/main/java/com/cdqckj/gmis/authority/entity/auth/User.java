package com.cdqckj.gmis.authority.entity.auth;
...
import static com.cdqckj.gmis.common.constant.InjectionFieldConstants.*;
...
public class User extends Entity<Long> {
     ...
     * #c_core_org
     *
     * @InjectionField(api = ORG_ID_CLASS, method = ORG_ID_METHOD, beanClass = Org.class) RemoteData<Long, com.cdqckj.gmis.authority.entity.core.Org>
     */
     ...
     * 秦川一次输错密码时间
     */
    @ApiModelProperty(value = "秦川一次输错密码时间")
     ...
     * 秦川登录时间
     */
    @ApiModelProperty(value = "秦川登录时间")
    @TableField("last_login_time")
    @Excel(name = "秦川登录时间", format = DEFAULT_DATE_TIME_FORMAT, width = 20)
    ...
    private BigDecimal pointOfSale;
    ...
    @Builder
    public User(Long id,BigDecimal pointOfSale,BigDecimal balance,BigDecimal singleLimit,Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime,
