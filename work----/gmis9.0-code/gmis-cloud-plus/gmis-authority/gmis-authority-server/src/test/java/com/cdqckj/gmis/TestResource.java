...
import com.cdqckj.gmis.authority.dao.common.ParameterMapper;
...
public class TestResource {
    ...
    public void testDict() {
        ...
        Collection<Dictionary> dictionaryList = new ArrayList<>();
        dictionaryList.add(Dictionary.builder().type("AAA").name("BBBB").build());
