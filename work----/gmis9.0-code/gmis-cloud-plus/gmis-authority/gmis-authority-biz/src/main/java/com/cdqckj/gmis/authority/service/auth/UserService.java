...
public interface UserService extends SuperCacheService<User> {
    ...
    IPage<RoleUserDTO> pageUserByRoleCode(PageParams<RoleUserDTO> page);
...
//    void updateLoginTime(String account);
     ...
     * @param wrapper
     */
    IPage<User> findPage(IPage<User> page, LbqWrapper<User> wrapper, String tenant);
    ...
    List<User> findUserByOrgIds(Set<Long> keys);
