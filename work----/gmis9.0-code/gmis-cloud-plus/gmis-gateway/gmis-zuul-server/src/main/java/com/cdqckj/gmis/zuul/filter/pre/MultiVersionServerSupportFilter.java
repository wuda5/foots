package com.cdqckj.gmis.zuul.filter.pre;

import cn.hutool.core.util.StrUtil;
import com.cdqckj.gmis.utils.StrPool;
import com.cdqckj.gmis.zuul.filter.BaseFilter;
 ...
 * <p>
 * 使用场景:
 * 用户gmis，在启动 gmis-authority-server 时， 将改成 spring.application.name: gmis-authority-server-gmis ，
 * 通过在请求每个请求头中增加 serviceSuffix=gmis , 请求就能通过网关路由到 gmis 的机器上
 * <p>
 * 该过滤器请勿使用在正式环境
 *
 * @author gmis
