package com.cdqckj.gmis.zuul.config;

import com.alibaba.fastjson.JSONArray;
import com.cdqckj.gmis.swagger2.SwaggerProperties;
    ...
    public List<SwaggerResource> get() {
        ...
        for (Route route : routes) {
            ...
            try {
                ...
                // 访问地址： http://gmis-test-server/swagger-resources  （其中 gmis-test-server 必须是服务的注册到nacos中的名称，否则无法调用成功 ）
