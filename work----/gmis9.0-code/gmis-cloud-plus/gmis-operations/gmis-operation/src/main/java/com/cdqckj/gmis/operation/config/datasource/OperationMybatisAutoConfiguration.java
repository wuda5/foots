...
public class OperationMybatisAutoConfiguration extends BaseMybatisConfiguration {


    public OperationMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
