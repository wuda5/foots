...
public class InvoiceMybatisAutoConfiguration extends BaseMybatisConfiguration {


    public InvoiceMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
