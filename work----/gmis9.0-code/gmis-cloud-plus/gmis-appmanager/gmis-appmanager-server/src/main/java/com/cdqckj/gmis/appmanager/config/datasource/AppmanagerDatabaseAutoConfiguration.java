package com.cdqckj.gmis.appmanager.config.datasource;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = AppmanagerDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${gmis.database.multiTenantType}')")
public class AppmanagerDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public AppmanagerDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 gmis.database.multiTenantType!=DATASOURCE，加载了 AppmanagerDatabaseAutoConfiguration");
    }
