package com.cdqckj.gmis.appmanager.config.mq;
...
public class AppManagerResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_APP_MANAGER);
