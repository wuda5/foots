...
public class AppmanagerMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public AppmanagerMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
