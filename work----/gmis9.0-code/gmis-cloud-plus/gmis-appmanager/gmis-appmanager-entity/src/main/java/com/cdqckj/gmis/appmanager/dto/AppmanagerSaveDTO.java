...
@Builder
@ApiModel(value = "AppmanagerSaveDTO", description = "应用管理表")
public class AppmanagerSaveDTO implements Serializable {
...
//    @NotNull(message = "租户code不为空")
    ...
    @Length(max = 255, message = "应用唯一标识长度不能超过255")
