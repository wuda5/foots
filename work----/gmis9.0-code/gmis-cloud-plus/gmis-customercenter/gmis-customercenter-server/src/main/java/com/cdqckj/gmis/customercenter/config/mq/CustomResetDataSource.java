package com.cdqckj.gmis.customercenter.config.mq;
...
public class CustomResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_CUSTOM);
