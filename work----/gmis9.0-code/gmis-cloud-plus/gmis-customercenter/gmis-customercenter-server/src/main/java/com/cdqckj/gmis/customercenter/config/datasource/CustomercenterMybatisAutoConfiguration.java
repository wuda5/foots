...
public class CustomercenterMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public CustomercenterMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
