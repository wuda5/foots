package com.cdqckj.gmis.customercenter.config.datasource;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = CustomercenterDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${gmis.database.multiTenantType}')")
public class CustomercenterDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public CustomercenterDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 gmis.database.multiTenantType!=DATASOURCE，加载了 CustomercenterDatabaseAutoConfiguration");
    }
