package com.cdqckj.gmis.oauthapi.config.mq;
...
public class OauthApiResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_OAUTH_API);
