...
@Builder
@ApiModel(value = "SecurityCheckRecordPageDTO", description = "安检计划记录")
public class SecurityCheckRecordPageDTO implements Serializable {
    ...
    @ApiModelProperty(value = "(安检状态)data_status,0 1 2 3未结单4 6 ,7  已结单")
    private ArrayList<Integer> dataStatusList;
    /**
     * 工单状态
     *             0: 待接单
     *             1: 已接单
