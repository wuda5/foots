...
@Builder
@ApiModel(value = "SecurityCheckItemsSaveDTO", description = "隐患列表")
public class SecurityCheckItemsSaveDTO implements Serializable {
    ...
    @ApiModelProperty(value = "隐患id及安检子项id")
    private Long scTermItemsId;
    @ApiModelProperty(value = "隐患名称及安检子项名称")
