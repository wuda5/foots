package com.cdqckj.gmis.securityed.config.mq;
...
public class SecurityResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_SECURITY);
