...
public class SecurityedMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public SecurityedMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
