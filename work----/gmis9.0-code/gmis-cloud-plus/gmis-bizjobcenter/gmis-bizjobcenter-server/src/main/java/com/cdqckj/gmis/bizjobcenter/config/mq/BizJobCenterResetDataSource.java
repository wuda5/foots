package com.cdqckj.gmis.bizjobcenter.config.mq;
...
public class BizJobCenterResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_BIZ_JOB_CENTER);
