package com.cdqckj.gmis.operationcenter.config.mq;
...
public class OperationCenterResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_OPERATION_CENTER);
