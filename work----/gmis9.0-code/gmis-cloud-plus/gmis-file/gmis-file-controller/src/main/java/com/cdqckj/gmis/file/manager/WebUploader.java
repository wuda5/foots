...
public class WebUploader {
    ...
    private boolean createFileFolder(String file, boolean hasTmp) {
        ...
        if (!tmpFile.exists()) {
            try {
                ...
                this.setErrorMsgEn("Unable to create folder");
                return false;
            }
        }
        ...
        if (hasTmp) {
            ...
            if (tmpFile.exists()) {
                ...
                try {
                    ...
                    this.setErrorMsgEn("Unable to create TMP file");
                    return false;
                }
            }
        }
    ...
    private String md5(String content) {
        ...
        try {
            ...
            this.setErrorMsgEn("Unable to generate MD5 signature for file");
            return null;
    ...
    private void setErrorMsgEn(String msgEn) {
        this.msgEn = msgEn;
    }
}
