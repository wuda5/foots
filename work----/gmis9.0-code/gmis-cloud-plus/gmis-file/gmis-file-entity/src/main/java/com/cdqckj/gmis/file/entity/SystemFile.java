...
@TableName("f_file")
@ApiModel(value = "SystemFile", description = "文件表")
public class SystemFile extends Entity<Long> {
    ...
    @Builder
    public SystemFile(Long id, LocalDateTime createTime, Long createUser, LocalDateTime updateTime, Long updateUser,
