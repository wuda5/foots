...
//                        Arrays.asList("f_.*"));
//        build.setUrl("jdbc:mysql://127.0.0.1:3306/gmis_file_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
////        build.setPassword("root");
//        build.setProjectRootPath(System.getProperty("user.dir") + "/gmis-backend/gmis-file");
//
...
////                EntityFiledType.builder().name("httpMethod").packagePath("com.cdqckj.gmis.common.enums.HttpMethod").gen(GenerateType.IGNORE).build()
//        ));
