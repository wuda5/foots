package com.cdqckj.gmis.file.config.mq;
...
public class FileResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_FILE);
    ...
    public Binding dsQueueBinding() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_DEVICE);
