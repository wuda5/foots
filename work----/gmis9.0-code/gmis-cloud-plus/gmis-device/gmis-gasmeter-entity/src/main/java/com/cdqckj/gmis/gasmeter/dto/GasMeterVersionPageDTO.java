...
@Builder
@ApiModel(value = "GasMeterVersionPageDTO", description = "气表版本")
public class GasMeterVersionPageDTO implements Serializable {
     ...
     * 是否单阶金额表：1:是；0-否
     */
    @ApiModelProperty(value = "是否单阶金额表：0:是；1-否")
