package com.cdqckj.gmis.device.config.datasource;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = DeviceDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${gmis.database.multiTenantType}')")
public class DeviceDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public DeviceDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 gmis.database.multiTenantType!=DATASOURCE，加载了 DeviceDatabaseAutoConfiguration");
    }
