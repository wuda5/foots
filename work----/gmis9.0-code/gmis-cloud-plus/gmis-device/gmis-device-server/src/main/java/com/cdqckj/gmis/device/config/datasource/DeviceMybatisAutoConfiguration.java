...
public class DeviceMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public DeviceMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
