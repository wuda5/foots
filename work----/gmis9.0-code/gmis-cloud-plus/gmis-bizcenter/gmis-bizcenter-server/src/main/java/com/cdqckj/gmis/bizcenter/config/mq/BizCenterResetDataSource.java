package com.cdqckj.gmis.bizcenter.config.mq;
...
public class BizCenterResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_BIZ_CENTER);
