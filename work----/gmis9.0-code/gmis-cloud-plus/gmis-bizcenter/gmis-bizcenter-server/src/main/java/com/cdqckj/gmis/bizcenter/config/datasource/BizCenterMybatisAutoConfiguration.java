...
public class BizCenterMybatisAutoConfiguration extends BaseMybatisConfiguration {


    public BizCenterMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
