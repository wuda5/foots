package com.cdqckj.gmis.bizcenter.config.datasource;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = BizCenterDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${gmis.database.multiTenantType}')")
public class BizCenterDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public BizCenterDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 gmis.database.multiTenantType!=DATASOURCE，启用了 AuthorityDatabaseAutoConfiguration");
    }
...
//    @ConditionalOnProperty(name = "gmis.database.isSeata", havingValue = "false", matchIfMissing = true)
...
//    @ConditionalOnProperty(name = "gmis.database.isSeata", havingValue = "true")
