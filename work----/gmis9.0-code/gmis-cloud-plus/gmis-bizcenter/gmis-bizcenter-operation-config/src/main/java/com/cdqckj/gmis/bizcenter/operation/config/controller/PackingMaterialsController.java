...
@Validated
@RestController
@RequestMapping("/operparam/packingmaterials")
@Api(value = "packingmaterials", tags = "")
//@PreAuth(replace = "street:")
public class PackingMaterialsController {
    @Autowired
    public CommonConfigurationApi commonConfigurationApi;
    @ApiOperation(value = "新增报装材料配置")
