...
@Validated
@RestController
@RequestMapping("/operparam/goodsworkordertype")
@Api(value = "goodsworkordertype", tags = "")
//@PreAuth(replace = "street:")
public class GoodsWorkOrderTypeController {
    @Autowired
    public CommonConfigurationApi commonConfigurationApi;
    @ApiOperation(value = "新增商品工单类型配置")
