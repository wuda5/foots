...
public class IdCardValidation {
    ...
    protected final static int NEW_CARD_NUMBER_LENGTH = 18;

    protected final static int OLD_CARD_NUMBER_LENGTH = 15;
    /**
     * 18位身份证中最后一位校验码
     */
    ...
    private static String contertToNewCardNumber(String oldCardNumber){
        ...
        buf.append(IdCardValidation.calculateVerifyCode(buf));
        return buf.toString();
    }
