package com.cdqckj.gmis.business.config.mq;
...
public class BusinessResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_BUSINESS);
