...
public class BusinessMybatisAutoConfiguration extends BaseMybatisConfiguration {


    public BusinessMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
