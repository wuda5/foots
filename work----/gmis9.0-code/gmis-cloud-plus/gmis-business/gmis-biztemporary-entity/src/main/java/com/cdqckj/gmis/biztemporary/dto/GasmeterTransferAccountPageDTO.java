...
@Builder
@ApiModel(value = "GasmeterTransferAccountPageDTO", description = "柜台综合：过户业务表，业务状态未完成之前不会更改主表数据")
public class GasmeterTransferAccountPageDTO implements Serializable {
