...
public class StatisticsMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public StatisticsMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
