package com.cdqckj.gmis.statistics.config.datasource;
...
@Slf4j
@MapperScan(
        basePackages = { "com.cdqckj.gmis.statistics", "com.cdqckj.gmis"}, annotationClass = Repository.class,
        sqlSessionFactoryRef = StatisticsDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${gmis.database.multiTenantType}')")
public class StatisticsDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public StatisticsDatabaseAutoConfiguration(MybatisPlusProperties properties,
        ...
        log.debug("检测到 gmis.database.multiTenantType!=DATASOURCE，加载了 StatisticsDatabaseAutoConfiguration");
    }
