...
import com.cdqckj.gmis.statistics.statistics.config.HeaderSetInterceptor;
 ...
 */
@Configuration
public class StatisticsWebConfiguration extends BaseConfig {
    ...
    */
    ...
    @Bean
    public HeaderSetInterceptor feignAddHeaderRequestInterceptor(){
        return new HeaderSetInterceptor();
    }
