...
@Builder
@ApiModel(value = "ReadMeterLatestRecordUpdateDTO", description = "每个表具最新抄表数据")
public class ReadMeterLatestRecordUpdateDTO implements Serializable {
     ...
     * 时间
     */
    @ApiModelProperty(value = "时间(抄表的月份时间)")
