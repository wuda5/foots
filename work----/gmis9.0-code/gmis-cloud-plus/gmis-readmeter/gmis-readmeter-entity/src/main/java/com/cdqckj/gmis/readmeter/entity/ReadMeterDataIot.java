...
@TableName("cb_read_meter_data_iot")
@ApiModel(value = "ReadMeterDataIot", description = "物联网抄表数据")
@AllArgsConstructor
public class ReadMeterDataIot extends Entity<Long> {
    ...
    //@TableField(value = "cycle_total_use_gas",updateStrategy = FieldStrategy.IGNORED)
    //@Excel(name = "周期累计用气量")
    ...
    //@TableField(value = "last_cycle_total_use_gas",updateStrategy = FieldStrategy.IGNORED)
    //@Excel(name = "周期累计用气量")
    ...
    @Builder
    public ReadMeterDataIot(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime, Integer dataBias,
