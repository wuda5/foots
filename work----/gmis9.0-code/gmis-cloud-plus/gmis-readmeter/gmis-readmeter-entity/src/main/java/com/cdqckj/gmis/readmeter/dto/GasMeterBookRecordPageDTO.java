...
@Builder
@ApiModel(value = "GasMeterBookRecordPageDTO", description = "抄表册关联客户")
public class GasMeterBookRecordPageDTO implements Serializable {
    ...
    @ApiModelProperty(value = "获取用户标识：0-已关联，1-未关联")
