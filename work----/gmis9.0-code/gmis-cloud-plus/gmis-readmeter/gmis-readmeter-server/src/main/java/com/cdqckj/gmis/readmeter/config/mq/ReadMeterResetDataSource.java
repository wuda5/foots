package com.cdqckj.gmis.readmeter.config.mq;
...
public class ReadMeterResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_READ_METER);
