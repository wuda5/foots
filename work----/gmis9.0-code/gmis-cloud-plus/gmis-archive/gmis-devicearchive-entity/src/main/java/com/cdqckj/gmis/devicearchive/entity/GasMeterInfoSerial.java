...
@TableName("da_gas_meter_info_serial")
@ApiModel(value = "GasMeterInfoSerial", description = "账户流水")
@AllArgsConstructor
public class GasMeterInfoSerial extends Entity<Long> {
    ...
    @Builder
    public GasMeterInfoSerial(Long id, Long createUser, LocalDateTime createTime, Long updateUser, LocalDateTime updateTime, 
                    String companyCode, String companyName, Long orgId, String orgName, Long businessHallId, 
                    String businessHallName, Long gasMeterInfoId, String gasMeterCode, String serialNo, String billNo, String billType, 
        ...
        this.gasMeterInfoId = gasMeterInfoId;
