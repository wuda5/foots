package com.cdqckj.gmis.devicearchive.config.mq;
...
public class DeviceArchiveResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_DEVICE_ARCHIVE);
