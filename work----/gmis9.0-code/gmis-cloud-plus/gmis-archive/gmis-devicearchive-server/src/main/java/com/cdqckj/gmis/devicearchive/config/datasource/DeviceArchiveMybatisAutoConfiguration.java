...
public class DeviceArchiveMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public DeviceArchiveMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
