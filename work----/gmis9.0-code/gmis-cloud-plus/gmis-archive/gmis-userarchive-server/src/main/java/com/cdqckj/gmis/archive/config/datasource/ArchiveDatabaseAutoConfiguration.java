package com.cdqckj.gmis.archive.config.datasource;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = ArchiveDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${gmis.database.multiTenantType}')")
public class ArchiveDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public ArchiveDatabaseAutoConfiguration(MybatisPlusProperties properties,
