...
public class ArchiveMybatisAutoConfiguration extends BaseMybatisConfiguration {


    public ArchiveMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
