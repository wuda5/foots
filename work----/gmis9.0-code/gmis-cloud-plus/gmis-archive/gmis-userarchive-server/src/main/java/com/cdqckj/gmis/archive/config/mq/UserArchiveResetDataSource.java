package com.cdqckj.gmis.archive.config.mq;
...
public class UserArchiveResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_USER_ARCHIVE);
