package com.cdqckj.gmis.admincenter.config.mq;
...
public class AdminCenterResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_ADMIN_CENTER);
