...
-- ----------------------------
BEGIN;
INSERT INTO `d_global_user` VALUES (1, 'admin', 'admin', '10086', '超级管理员', '604141215@qq.com', 'e10adc3949ba59abbe56e057f20f883e', b'1', '2019-08-29 16:50:35', 1, '2019-08-29 16:50:35', 1);
INSERT INTO `d_global_user` VALUES (2, 'admin', 'demoAdmin', '10086', '超级管理员[演示]', '604141215@qq.com', 'e10adc3949ba59abbe56e057f20f883e', b'1', '2019-10-30 10:29:21', 1, '2019-10-30 10:29:23', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `d_tenant` VALUES (616676078974402977, '0000', '秦川的内置企业', 'CREATE', 'NORMAL', b'1', '秦川', NULL, NULL, '内置企业，请勿删除', '2019-08-29 16:50:35', 1, '2019-08-29 16:50:35', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `xxl_job_qrtz_trigger_group` VALUES (1, 'gmis-jobs-server', 'gmis执行器', 1, 0, '127.0.0.1:8771');
...
-- ----------------------------
BEGIN;
INSERT INTO `xxl_job_qrtz_trigger_registry` VALUES (7, 'EXECUTOR', 'gmis-jobs-server', '127.0.0.1:8771', '2020-04-26 00:21:44');
COMMIT;
