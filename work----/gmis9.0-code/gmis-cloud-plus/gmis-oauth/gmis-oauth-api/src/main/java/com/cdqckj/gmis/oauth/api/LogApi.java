...
import com.cdqckj.gmis.oauth.api.hystrix.LogApiHystrix;
 ...
 * @date 2019/07/02
 */
@FeignClient(name = "${gmis.feign.authority-server:gmis-authority-server}", fallback = LogApiHystrix.class, qualifier = "logApi")
