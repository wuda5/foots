...
@Builder
@ApiModel(value = "FunctionSwitchUpdateDTO", description = "功能项配置")
public class FunctionSwitchUpdateDTO implements Serializable {
     ...
     * 客户编号前缀
     */
    @ApiModelProperty(value = "缴费编号前缀")
    @Length(max = 100, message = "缴费编号前缀长度不能超过100")
