...
public class ConfigMybatisAutoConfiguration extends BaseMybatisConfiguration {


    public ConfigMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
