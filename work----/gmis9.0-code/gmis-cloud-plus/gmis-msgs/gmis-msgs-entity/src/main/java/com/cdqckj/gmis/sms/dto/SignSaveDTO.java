...
@Builder
@ApiModel(value = "SignSaveDTO", description = "短信签名")
public class SignSaveDTO implements Serializable {
    ...
    public SignSaveDTO(String signName, Integer signType, Integer documentType,
