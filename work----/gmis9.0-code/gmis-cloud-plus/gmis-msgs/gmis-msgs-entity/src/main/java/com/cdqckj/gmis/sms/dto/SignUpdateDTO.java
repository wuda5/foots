...
@Builder
@ApiModel(value = "SignUpdateDTO", description = "短信签名")
public class SignUpdateDTO implements Serializable {
    ...
    public SignUpdateDTO(Long id, String signName, Integer signType, Integer documentType,
                       Integer international, Integer usedMethod) {
        this.id = id;
