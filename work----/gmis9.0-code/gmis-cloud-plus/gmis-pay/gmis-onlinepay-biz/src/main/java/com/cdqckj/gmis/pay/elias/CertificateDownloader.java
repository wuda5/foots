package com.cdqckj.gmis.pay.elias;


import com.cdqckj.gmis.pay.elias.cert.CertificateItem;
import com.cdqckj.gmis.pay.elias.cert.CertificateList;
import com.cdqckj.gmis.pay.elias.cert.PlainCertificateItem;
...
public class CertificateDownloader implements Runnable {
    ...
    private List<PlainCertificateItem> downloadCertificate() throws IOException, GeneralSecurityException {
        WechatPayHttpClientBuilder builder = WechatPayHttpClientBuilder.create()
                .withMerchant(merchantId, serialNo, PemUtil.loadPrivateKey(new ClassPathResource(privateKeyFilePath).getInputStream()));//new FileInputStream(privateKeyFilePath)
