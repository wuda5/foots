package com.cdqckj.gmis.pay.config.datasource;
...
@MapperScan(
        ...
        sqlSessionFactoryRef = PayDatabaseAutoConfiguration.DATABASE_PREFIX + "SqlSessionFactory")
@EnableConfigurationProperties({MybatisPlusProperties.class})
@ConditionalOnExpression("!'DATASOURCE'.equals('${gmis.database.multiTenantType}')")
public class PayDatabaseAutoConfiguration extends BaseDatabaseConfiguration {
    /**
     * 每个数据源配置不同即可
     */
    final static String DATABASE_PREFIX = "master";

    public PayDatabaseAutoConfiguration(MybatisPlusProperties properties,
