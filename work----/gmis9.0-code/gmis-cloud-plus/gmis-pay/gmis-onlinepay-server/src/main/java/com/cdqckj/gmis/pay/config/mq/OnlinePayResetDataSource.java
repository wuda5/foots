package com.cdqckj.gmis.pay.config.mq;
...
public class OnlinePayResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_ONLINE_PAY);
