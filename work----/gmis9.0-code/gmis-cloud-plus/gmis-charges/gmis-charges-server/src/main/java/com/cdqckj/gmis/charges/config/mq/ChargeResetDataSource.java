package com.cdqckj.gmis.charges.config.mq;
...
public class ChargeResetDataSource {
    ...
    public Queue dsQueue() {
        String queueName = mqQueueName.getQueueName(BizMqQueue.TENANT_DS_QUEUE_BY_CHARGE);
