...
@Builder
@ApiModel(value = "ReadGasMeterDataVO", description = "抄表数据")
public class ReadGasMeterDataVO implements Serializable,Comparable<ReadGasMeterDataVO> {
    ...
    private String readEmterUserName;
    /**
     * 记录员id
     */
    ...
    @Override
    public int compareTo(ReadGasMeterDataVO o) {
