...
@Builder
@ApiModel(value = "TollItemCycleLastChargeRecordUpdateDTO", description = "周期收费项最后一次缴费")
public class TollItemCycleLastChargeRecordUpdateDTO implements Serializable {
