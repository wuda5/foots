...
@Builder
@ApiModel(value = "ChargeRecordPageDTO", description = "缴费记录")
public class ChargeRecordPageDTO implements Serializable {
     ...
     * 期间查询-创建时间开始
     */
    @ApiModelProperty(value = "期间查询-创建时间开始")
    private LocalDateTime createTimeSt;

    /**
     * 期间查询-创建时间结束
     */
    @ApiModelProperty(value = "期间查询-创建时间结束")
    private LocalDateTime createTimeEd;
