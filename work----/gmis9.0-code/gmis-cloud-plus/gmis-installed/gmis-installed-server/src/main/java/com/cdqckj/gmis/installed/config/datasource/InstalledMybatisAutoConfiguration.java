...
public class InstalledMybatisAutoConfiguration extends BaseMybatisConfiguration {

    public InstalledMybatisAutoConfiguration(DatabaseProperties databaseProperties) {
