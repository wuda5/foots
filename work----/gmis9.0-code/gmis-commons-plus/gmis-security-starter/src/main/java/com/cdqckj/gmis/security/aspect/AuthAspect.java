package com.cdqckj.gmis.security.aspect;
...
public class AuthAspect implements ApplicationContextAware {
     ...
     */
    @Around("execution(public * com.cdqckj.gmis.base.controller.*.*(..)) || " +
            "@annotation(com.cdqckj.gmis.security.annotation.PreAuth) || " +
            "@within(com.cdqckj.gmis.security.annotation.PreAuth)"
    )
