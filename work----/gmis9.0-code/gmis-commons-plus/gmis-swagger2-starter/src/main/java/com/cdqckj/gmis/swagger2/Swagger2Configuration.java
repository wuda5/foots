 ...
 * Swagger2 启动类
 * 启动条件：
 * 1，配置文件中gmis.swagger.enabled=true
 * 2，配置文件中不存在：gmis.swagger.enabled 值
 *
 * @author gmis
...
public class Swagger2Configuration implements WebMvcConfigurer {
    ...
    public static class ZhSecurityConfiguration {
        ...
        @ConditionalOnProperty(name = "gmis.swagger.production", havingValue = "true")
        ...
        @Bean
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "gmis.swagger.basic.enable", havingValue = "true")
        ...
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "gmis.swagger.markdown.enable", havingValue = "true")
