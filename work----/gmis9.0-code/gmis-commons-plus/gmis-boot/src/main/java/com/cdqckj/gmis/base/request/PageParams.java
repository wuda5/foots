...
import com.cdqckj.gmis.utils.AntiSqlFilter;
...
public class PageParams<T> {
    ...
    @ApiModelProperty(value = "权限的控制,默认为添加为0 其他控制为其他值", example = "1")
    private long dataScope = 0;
    ...
    @ApiModelProperty("下拉框参数")
    private List<ExcelSelectortDTO> comboboxList = new ArrayList<>();

    @ApiModelProperty("下拉框级联参数")
    private List<ExcelCascadeSelectorDTO> cascadeSelectors= new ArrayList<>();

    @ApiModelProperty("级联源sheet页面")
