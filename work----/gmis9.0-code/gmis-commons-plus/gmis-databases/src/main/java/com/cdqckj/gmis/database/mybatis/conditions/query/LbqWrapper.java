package com.cdqckj.gmis.database.mybatis.conditions.query;
...
import com.cdqckj.gmis.database.mybatis.typehandler.BaseLikeTypeHandler;
...
public class LbqWrapper<T> extends AbstractLambdaWrapper<T, LbqWrapper<T>>
     ...
     * @remark
     */
    public DataScope getTheDataScope() {
        return dataScope;
    }

    public void setTheDataScope(DataScope dataScope) {
