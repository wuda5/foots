...
import com.cdqckj.gmis.database.injector.MySqlInjector;
import com.cdqckj.gmis.database.mybatis.typehandler.RightLikeTypeHandler;
import com.cdqckj.gmis.database.parsers.DynamicTableNameParser;
import com.cdqckj.gmis.database.properties.DatabaseProperties;
import com.cdqckj.gmis.database.properties.MultiTenantType;
import com.cdqckj.gmis.database.servlet.TenantWebMvcConfigurer;
import com.cdqckj.gmis.context.BaseContextHandler;
import com.cdqckj.gmis.database.mybatis.WriteInterceptor;
import com.cdqckj.gmis.database.mybatis.typehandler.FullLikeTypeHandler;
import com.cdqckj.gmis.database.mybatis.typehandler.LeftLikeTypeHandler;
...
/**
 * Mybatis 常用重用拦截器，gmis.database.multiTenantType=任意模式 都需要实例出来
 * <p>
 * 拦截器执行一定是：
...
public class BaseMybatisConfiguration {
    ...
    @ConditionalOnProperty(name = "gmis.database.isNotWrite", havingValue = "true")
