package com.cdqckj.gmis.log.aspect;
...
import com.cdqckj.gmis.log.event.SysLogEvent;
import com.cdqckj.gmis.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     *
     * execution(public * com.cdqckj.gmis.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* com.cdqckj.gmis.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(com.cdqckj.gmis.log.annotation.SysLog) 解释：
     * 标记了@SysLog 注解的方法
     */
    @Pointcut("execution(public * com.cdqckj.gmis.base.controller.*.*(..)) || @annotation(com.cdqckj.gmis.log.annotation.SysLog)")
