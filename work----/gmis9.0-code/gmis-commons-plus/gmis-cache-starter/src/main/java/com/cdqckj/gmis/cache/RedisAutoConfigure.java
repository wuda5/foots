...
import com.cdqckj.gmis.cache.lock.RedisDistributedLock;
import com.cdqckj.gmis.cache.repository.CacheRepository;
import com.cdqckj.gmis.cache.repository.RedisRepositoryImpl;
import com.cdqckj.gmis.cache.properties.CustomCacheProperties;
import com.cdqckj.gmis.cache.utils.RedisObjectSerializer;
...
@ConditionalOnProperty(name = "gmis.cache.type", havingValue = "REDIS", matchIfMissing = true)
