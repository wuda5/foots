...
public class DateUtils {
    ...
    public final static String DEFAULT_DATE_FORMAT_NU = "yyyyMMdd";
    public final static String DEFAULT_FULL_FORMAT_NU = "yyyyMMddHHmmss";
    /**
     * 一个月平均天数
     */
...
//                    .get(MessageConstants.DATE_LIMIT));
        }
        return dateType;
    }
...
//----------//----------//----------//----------//----------//----------//----------//----------//----------//----------//----------
    ...
    /***
     * 通过指定 年份 和 月份 数字 得到对应的java8 时间日期 如：2012-02-01
     * */
    public static LocalDate getDate8(Integer year, Integer month)  {

        try {
            DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");//代替simpleDateFormat

            String m = month>=10?month+"":"0"+month;// >10

            return LocalDate.parse(year + "-" + m + "-01", dtf);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static void main(String[] args) {
        LocalDate date8 = getDate8(2011, 10);
    }
}
