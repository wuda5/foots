package com.cdqckj.gmis.converter;
...
import static com.cdqckj.gmis.exception.BaseException.BASE_VALID_PARAM;
import static com.cdqckj.gmis.utils.DateUtils.*;
...
public class String2DateConverter extends BaseDateConverter<Date> implements Converter<String, Date> {
    ...
    protected static Date parseDate(String dateStr, String format) {
        ...
        try {
            ...
            throw new BizException(BASE_VALID_PARAM, e.getMessage(),e.getMessage());
        }
        return date;
    }
