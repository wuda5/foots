...
public class TestInvoiceGenerator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(System.getProperty("user.dir") + "/gmis-cloud-plus/gmis-invoice");
        build.setProjectRootPath(System.getProperty("user.dir") + "/gmis-cloud-plus/gmis-invoice");
...
//                "gt_invoice",
//                "gt_invoice_details",
//                "gt_seller_taxpayer_info",
                "gt_receipt_invoice_association"
        );
        CodeGeneratorConfig build = CodeGeneratorConfig.
                build("invoice",// haha 服务
                        "", // 子模块
                        "songyz", // 作者
                        "gt_", // 表前缀
                        tables);
