 ...
 * @date 2020/07/21
 */
public class TestBizTemporaryGenerator {
    /***
    ...
    public static void main(String[] args) {
        ...
        System.out.println(System.getProperty("user.dir") + "/gmis-cloud-plus/gmis-business");
        build.setProjectRootPath(System.getProperty("user.dir") + "/gmis-cloud-plus/gmis-business");
...
//                "gt_account_open_task_info",
//                "gt_adjust_price_process",
//                "gt_open_account_record",
//                "gt_gas_meter_temp",
                "gt_customer_temp"
        );
        CodeGeneratorConfig build = CodeGeneratorConfig.
                build("biztemporary",// haha 服务
                        "", // 子模块
                        "songyz", // 作者
                        "gt_", // 表前缀
                        tables);
