 ...
 * @date 2020/07/21
 */
public class TestSummaryBillGenerator {
    /***
    ...
    public static void main(String[] args) {
        ...
        System.out.println(System.getProperty("user.dir") + "/gmis-cloud-plus/gmis-charges");
        build.setProjectRootPath(System.getProperty("user.dir") + "/gmis-cloud-plus/gmis-charges");
...
//                "gt_summary_bill",
//                "gt_adjust_calculation_record",
//                "gt_summary_bill_detail",
                "gt_adjust_price_record"

        );
        CodeGeneratorConfig build = CodeGeneratorConfig.
                build("charges",// haha 服务
                        "", // 子模块
                        "songyz", // 作者
                        "gt_", // 表前缀
                        tables);
        ...
        build.setUrl("jdbc:mysql://172.16.92.54:3306/gmis_base_0000?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull");
