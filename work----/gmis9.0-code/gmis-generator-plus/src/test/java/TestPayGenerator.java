...
//        CodeGeneratorConfig build = buildHeheEntity();
        ...
        System.out.println(System.getProperty("user.dir") + "/gmis-pay");
        build.setProjectRootPath(System.getProperty("user.dir") + "/gmis-pay");
