 ...
 * @date 2019/05/25
 */
public class TestPayVueGenerator {
    /***
...
//        keyField.put("key", new GenTableColumn("key", YES, YES, YES, YES, HtmlType.INPUT));
        keyField.put("payNotes", new GenTableColumn("payNotes", YES, YES, YES, YES, HtmlType.INPUT));
...
//        keyField.put("readony_", new GenTableColumn("readony_", NO, NO, YES, NO, HtmlType.RADIO_BUTTON));
        ...
        keyField.put("pay", new GenTableColumn("pay", YES, YES, YES, YES, HtmlType.INPUT));
        // 指定 type2 字段使用 select 样式， 拉取枚举 ProductType2Enum 的值
        keyField.put("payOpenId", new GenTableColumn("payOpenId", YES, YES, YES, YES, HtmlType.INPUT));
        keyField.put("notify", new GenTableColumn("notify", YES, YES, YES, YES, HtmlType.INPUT));
        //表名
        map.put("m_wx_pay", keyField);
