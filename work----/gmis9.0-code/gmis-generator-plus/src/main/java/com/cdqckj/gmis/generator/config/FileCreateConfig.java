package com.cdqckj.gmis.generator.config;
...
public class FileCreateConfig implements IFileCreate {
    ...
    private GenerateType generateAPI1 = GenerateType.IGNORE;
//    private GenerateType generateAPI1FallBack = GenerateType.IGNORE;
    ...
    public FileCreateConfig(GenerateType generate) {
        ...
        if (generate != null) {
            ...
            this.generateAPI1= GenerateType.IGNORE;
        }
    ...
    public FileCreateConfig(GenerateType generate, boolean isVue) {
        ...
        if (isVue) {
            ...
            if (generate != null) {
                ...
                this.generateAPI1= generate;
//                this.generateAPI1FallBack= generate;
            }
        }
    ...
    public boolean isCreate(ConfigBuilder configBuilder, FileType fileType, String filePath) {
        ...
        if (FileType.ENTITY == fileType) {
            ...
            //api--一定要在 api.js之前
            if (filePath.endsWith("BizApi.java")) {
                return isCreate(generateAPI1,file );
            }
            //api.histryx
//            if (filePath.endsWith("BizApiFallback.java")) {
//                return isCreate(generateAPI1FallBack, file);
//            }
