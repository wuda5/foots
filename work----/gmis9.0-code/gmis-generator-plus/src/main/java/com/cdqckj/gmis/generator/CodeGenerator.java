package com.cdqckj.gmis.generator;
...
import com.cdqckj.gmis.generator.ext.FileOutConfigExt;
import com.cdqckj.gmis.generator.ext.FreemarkerTemplateEngineExt;
import com.cdqckj.gmis.generator.ext.MySqlQueryExt;
import com.cdqckj.gmis.generator.ext.OracleQueryExt;
...
public class CodeGenerator {
    ...
    public static final String BIZ_API_PATH = "BizApi";
//    public static final String BIZ_API_FALLBACK_PATH = "BizApiFallback";
...
//        packageMap.put(DTO_PATH, parentPackage + ".dto" + childPackageName);
        ...
        packageMap.put(BIZ_API_PATH, parentPackage + ".api" + childPackageName);
//        packageMap.put(BIZ_API_FALLBACK_PATH, parentPackage + ".api.hystrix" + childPackageName);
        return packageMap;
    }
...
//        focList.add(new FileOutConfigExt(basePath, DTO_PATH, config));
        ...
        focList.add(new FileOutConfigExt(basePath, BIZ_API_PATH, config));

//        focList.add(new FileOutConfigExt(basePath, BIZ_API_FALLBACK_PATH, config));
