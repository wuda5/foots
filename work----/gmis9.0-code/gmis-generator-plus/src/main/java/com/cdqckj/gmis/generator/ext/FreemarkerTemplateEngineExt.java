            ...
            if (!api.contains("\"")) {
                if (api.contains(".")) {
                    if (api.endsWith("class")) {
                        ...
                        importPackages.add("com.cdqckj.gmis.common.constant.InjectionFieldConstants");
                    }
                } else {
                    importPackages.add(String.format("static com.cdqckj.gmis.common.constant.InjectionFieldConstants.%s", api));
                }
            }
            if (!method.contains("\"")) {
                if (method.contains(".")) {
                    ...
                    importPackages.add(String.format("static com.cdqckj.gmis.common.constant.InjectionFieldConstants.%s", method));
                }
            }
            if (typePackage.contains(".")) {
                importPackages.add(typePackage);
            }
            importPackages.add("com.cdqckj.gmis.injection.annonation.InjectionField");
            importPackages.add("com.cdqckj.gmis.model.RemoteData");
        }
    }
