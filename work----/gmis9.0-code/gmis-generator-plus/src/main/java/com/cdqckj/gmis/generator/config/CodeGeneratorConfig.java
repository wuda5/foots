...
public class CodeGeneratorConfig {
     ...
     * 基础包   所有的代码都放置在这个包之下
     */
    String packageBase = "com.cdqckj.gmis.authority";
    /**
     * 子包名称
     ...
     * 项目统一前缀  比如：  cloud-
     */
    private String projectPrefix = "gmis-";
    ...
    String groupId = "com.cdqckj.gmis";
...
//    private String xmlPath = "";
     ...
     * 驱动连接的URL
     */
    private String url = "jdbc:mysql://127.0.0.1:3306/gmis_base_0000?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull";
    /**
     * 驱动名称
     */
    ...
    public static class Vue {
        private String viewsPath = "views" + File.separator + "gmis";
