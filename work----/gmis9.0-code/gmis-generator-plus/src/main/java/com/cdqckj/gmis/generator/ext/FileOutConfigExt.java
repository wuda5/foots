package com.cdqckj.gmis.generator.ext;
    ...
    public FileOutConfigExt(String innerBasePath, String modularSuffix, CodeGeneratorConfig config) {
        ...
        switch (modularSuffix) {
            ...
            case CodeGenerator.QUERY_PATH:
                ...
                break;
            case CodeGenerator.BIZ_API_PATH:
                this.setTemplatePath("/templates/api.java.ftl");
                this.projectSuffix = "-api";
                this.generateType = fileCreateConfig.getGenerateAPI1();
                this.modularSuffix = CodeGenerator.BIZ_API_PATH;
                break;
//            case CodeGenerator.BIZ_API_FALLBACK_PATH:
//                this.setTemplatePath("/templates/apif.java.ftl");
//                this.projectSuffix = "-api";
//                this.generateType = fileCreateConfig.getGenerateAPI1FallBack();
//                this.modularSuffix = CodeGenerator.BIZ_API_FALLBACK_PATH;
//                break;
...
//                    || CodeGenerator.BIZ_API_FALLBACK_PATH.equals(modularSuffix)
//                    || CodeGenerator.BIZ_API_PATH.equals(modularSuffix)
        ...
        } else if (CodeGenerator.BIZ_API_PATH.equals(innerModularSuffix)) {
            innerModularSuffix = "api";
//        } else if (CodeGenerator.BIZ_API_FALLBACK_PATH.equals(innerModularSuffix)) {
//            innerModularSuffix = "api"+File.separator+"hystrix";
        } else {
